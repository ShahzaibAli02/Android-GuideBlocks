...
import com.contextu.al.barcodescanner.camera.CameraReticleAnimator
import com.contextu.al.barcodescanner.camera.FrameProcessorBase
...
class BarcodeProcessor(
    ...
    override fun onSuccess(
        ...
        if (barcodeInCenter == null) {
            ...
            graphicOverlay.add(BarcodeReticleGraphic(barCodeModel, graphicOverlay, cameraReticleAnimator))
            ...
            if (sizeProgress < 1) {
                ...
                graphicOverlay.add(BarcodeConfirmingGraphic(barCodeModel, graphicOverlay, barcodeInCenter))
                ...
                if (PreferenceUtils.shouldDelayLoadingBarcodeResult(graphicOverlay.context)) {
                    ...
                    graphicOverlay.add(BarcodeLoadingGraphic(barCodeModel, graphicOverlay, loadingAnimator))
